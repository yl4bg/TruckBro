...
<body>
		<h3>共有<span data-bind="text: $root.totalNumOfEvent"></span>个路况。鼠标移动至单个路况显示详情。</h3>
		...
		<script type="text/javascript" src="<c:url value="/resources/js/eventsMapViewKnockOut.js" />"></script>
